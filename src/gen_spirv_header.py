...
def main() -> None:
    if len(sys.argv) != 54:
        print("usage: gen_spirv_header.py <...dfttest binaries...> "
              ...
              "<nnedi3_16_count> <nnedi3_16_assemble> <nnedi3_32_pad> <nnedi3_32_prescreen> "
              "<nnedi3_32_predict> <nnedi3_32_count> <nnedi3_32_assemble> <out header>")
        sys.exit(1)
    ...
    bl_shared_16, bl_shared_32, bl_plain_16, bl_plain_32, bm3d, bm3d_agg, \
        ...
        nn16_p, nn16_s, nn16_r, nn16_c, nn16_a, nn32_p, nn32_s, nn32_r, nn32_c, nn32_a, \
